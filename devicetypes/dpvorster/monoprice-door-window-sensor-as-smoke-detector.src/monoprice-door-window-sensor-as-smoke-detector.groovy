 ...
 *
 *  Updated to be used as a smoke detector
 *
 *  Author: SmartThings / dpvorster
 *  Date: 2013-11-3
 */
...
metadata {
	...
	definition (name: "Monoprice Door/Window Sensor as Smoke Detector", namespace: "dpvorster", author: "dpv") {
